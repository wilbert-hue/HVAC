...
export function FilterPresets() {
    ...
    return [
  {
    id: 'top-markets',
    name: 'Top Markets',
        description: 'Top 3 European countries by 2023 market size',
    icon: <Globe className="h-4 w-4" />,
  ...
  },
      {
        id: 'growth-leaders',
        name: 'Growth Leaders',
        description: 'Top 2 European countries with highest CAGR',
      ...
      },
      {
        ...
        description: 'Top 5 European countries with highest CAGR',
      ...
      },
  {
    ...
    description: 'All European geographies and segments matrix view',
